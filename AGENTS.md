...
**D-0295 Footer — full published sitemap (D-0294 notice strip removed; D-0293 compact accordion; D-0292 Trust · Legal merge; Resources removed; D-0291 Business section leaves restored — visual hub + short pages; D-0290 continuous-page IA superseded; D-0289 visual atmosphere retained on hub/leaves; D-0288 leaf pattern restored as primary; D-0287 7-section content; D-0286 economic-value; D-0285 Business/Partners contrast + body i18n; D-0284 Business page; D-0283 Partners footer-only + header Sign In after language; D-0282 public-copy consistency; HDM≠BioMath; execution/status; legal/FAQ hygiene) + D-0281 follow-through (i18n / partner formula / unused home catalog) + Master positioning / legal / FAQ update (D-0280) + Lab video mobile controls below stage (D-0279) + Lab video Site main clip first (D-0278) + Lab video multi-clip switcher + SAVEN second clip (D-0277) + Lab video opening dots-person restored (D-0276) + Lab video chapter scrub + timed captions (D-0275) + Lab video original framing restored (D-0274) + Lab video symmetric page-embed (D-0273) + Lab video clear overlay + links (D-0272) + Lab video soft page-embed (D-0271 grain/vignette/grade retired for clear picture) + Lab full-bleed amplified video (D-0270 cut/edges superseded) + Lab designed video band (D-0269 framing retired) + Lab single video splash (D-0268) + Lab light video + cinematic splash (D-0267) + Test / Lab experiments hub (D-0263) + Dark clarity / Explore SAVEN gray-blue cards (D-0262) + Home photo collage restored (D-0261) + Public chrome: no “In Development” maturity messaging + BMC 200+ services under 20 categories (D-0252) + Investors locale repair / downloads verify (D-0253) + BioMath Core diagram hover links (D-0251) + Theme bootstrap useServerInsertedHTML (D-0250) + Home closing SAVEN ↔ YouTube frame match (D-0249) + Investors polish / related sync / i18n (D-0248) + Nav / Research removal / Investors chrome (D-0247) + Investors professional page (D-0246) + Search balance / home YouTube (D-0245) + Contact rate limit + BMC polish (D-0243) + Performance / Downloads (D-0241) + Security / SEO / Marketing hygiene (D-0240) + BioMath Core unified English diagram series + home bridge (D-0239 / D-0238 / D-0237 / D-0236 / D-0235 / D-0234 / D-0233 / D-0232 / D-0231 / D-0230 / D-0229 / D-0228 / D-0227)** — Owner-authorized: **D-0295** footer lists all Legal leaves and Business section leaves (complete published sitemap behind accordion); **D-0294** footer notice drops Privacy/Terms strip; **D-0293** footer sections collapse by default; **D-0292** merges footer Trust + Legal, removes Resources column (Search header-only; Security Issue beside Trust Security; FAQ→Company; Lab→Labs; Install→Company); **D-0291**–**D-0227** remain as previously logged except superseded continuous-page IA. Prior D-0194–D-0295 remain in force — read `docs/ADMIN_PLATFORM.md`, `docs/SITE_ASSIGNMENT.md`, `docs/SITE_AUDIT_REPORT.md`, and D-0134–D-0295.

Hero: brand **Intelligence for Robots That Help People** + living photoreal help collage (D-0261; Lab video experiments at `/lab/` — D-0279 mobile controls below stage + D-0278 Site default + D-0277 multi-clip switcher Site / GWR / SAVEN + D-0276 opening dots-person on GWR + D-0275 chapter scrub + timed captions on D-0274 original framing + D-0273 symmetric soft page-embed on D-0272 clear overlay/links). Post-hero (when clarity on — D-0219/D-0220/D-0221/D-0225/D-0226/D-0227/D-0228/D-0229/D-0230/D-0231/D-0232/D-0233/D-0234/D-0235/D-0236/D-0237/D-0238/D-0239): visual definition + 3-step chain + **Explore SAVEN** letter showcase + audience fork, then **one** care-focused living carousel (D-0150) with stage “why SAVEN”, then **merged BioMath bridge**, then boundaries (“what we are not”), compact **Flagship Gateway** (Lab / Interface / Future Lab / Investors — D-0194) + **Explore SAVEN** closing map (D-0216/D-0217/D-0218; full corner clusters — D-0221). **Page bodies + UI chrome for all 10 locales** (`en`/`es`/`de`/`fr`/`ja`/`zh-cn`/`ar`/`he`/`uk`/`ru`; English canonical). Header: logo + **important Layer-1 hubs** (≤7: Home, Labs, Systems, Applications, Technology, Investors — D-0283 / D-0280 / D-0247; Partners footer-only under Company; Trust footer-only; Research hub removed) + Search + sun/moon theme + language with flags + Sign In/Up after language (D-0153/D-0155/D-0156/D-0194/D-0220/D-0247/D-0283; Install app is footer-only — D-0164; same type as Resources links — D-0223 / D-0224). Hubs **and domain leaves** share one visual shell (`DomainVisualPage` / Layer-1 hub grammar); BioMath Core leaf uses a dedicated navy/gold BMC page with **unified English owner-grade illustration panels in themeable site chrome** within site grammar (D-0228–D-0238). Footer: **full published sitemap** behind accordion (D-0295) including **Home**, **Architecture**, **Trust · Legal** (all trust + all legal leaves — D-0292/D-0295), Labs (+ **Lab** experiments — D-0263), Media, Contact, FAQ, **Sitemap** HTML page (D-0296 — `/sitemap/`; not `sitemap.xml`), **Partners**, **Business** + Business section leaves (D-0284/D-0291/D-0295), **BioMath Core** under Company; Resources column removed; Search is header-only (D-0292); footer medical notice strip removed (D-0294). Auth: `/[locale]/auth/sign-in/` — email/password + Google; soft-degrade when unset. Contact: SMTP when configured else mailto to `info@savencore.com` (D-0173/D-0194). Brand text: `BrandName` matches logo wordmark. Tagline: Turning Intelligence Into Human Care. Deploy target: Vercel; see `docs/VERCEL_DEPLOY.md`.
...
- inventing additional leaf marketing pages beyond the published visual domain set + D-0194 leaves (Roadmap / Resources security / Investors contact; Research hub removed — D-0247) + D-0220 `/search/` + D-0228 `/foundation/biomath-core/` + D-0263 `/lab/` experiments hub (not a marketing leaf) + D-0280 `/partners/`, `/legal/disclaimer/`, `/trust/responsible-development/`;
- graph visualization or knowledge CMS;
- neon, glow, or futuristic decoration outside the approved experience grammar (D-0267 / D-0268 / D-0269 / D-0270 / D-0271 / D-0272 / D-0273 / D-0274 / D-0275 / D-0276 / D-0277 / D-0278 / D-0279 authorize Lab-only cinematic video treatment on `/lab/` — multi-clip soft-embedded playlist with **compact straight-corner switcher** + **Site** default main clip + GWR **opening dots-person** + SAVEN S-2 clip + **original 16:9 framing** (no zoom-crop) + **symmetric** feathered edges (equal top/bottom + left/right) + clear picture (no grain / heavy vignette / heavy grade) + text overlay + explore links + **clickable chapter ticks** + **timed captions** per active clip + **mobile interactive chrome below the stage** (D-0279) + light side ambient + gentle Ken Burns / softened cursor / light parallax — not the public home; no editorial picture frame; no hard black stage box; no depth-blur duplicate video; D-0217/D-0218 authorizes soft brand glow on the home closing SAVEN wordmark only; D-0225/D-0226 authorize contained cinematic letter glow inside the clarity Explore SAVEN band only; D-0228/D-0229/D-0230/D-0231/D-0232/D-0233/D-0234/D-0235/D-0236/D-0237/D-0238/D-0239 authorize limited BMC orange/blue accent glow on the BioMath Core leaf hero/category icons and illustration panel chrome only — glow already present inside owner illustration assets is allowed).
