...
- logo asset / photography imagery beyond approved homepage living photoreal hero + care living carousel (D-0135–D-0152), domain thematic mastheads under `public/domain/` / `public/hub/` (D-0159–D-0160), and BioMath Core illustration panels under `public/domain/foundation/biomath-core/` / `diagrams/` (D-0231/D-0234/D-0235/D-0236/D-0237/D-0238/D-0239 — unified English owner-grade diagrams in themeable chrome; tighter harmonious panel max-widths; sharper HUD hero band; category artboard panels without per-card counts; Black Box sensitive-storage architecture intent + soft Trust/Legal policy links only — still no fake deployment photography or invented KPI dashboards);
