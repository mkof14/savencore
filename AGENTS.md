...
**Admin Platform / Social footer (D-0176)** — restricted `/[locale]/admin/` vertical slice (RBAC, email template library + preview, media library actions, honest marketing/tech monitoring) + configurable footer social icons; public Experience Redesign UI freeze (D-0175) remains the approved public snapshot — read `docs/ADMIN_PLATFORM.md`, `docs/SITE_ASSIGNMENT.md`, `docs/SITE_AUDIT_REPORT.md`, and D-0134–D-0176.
