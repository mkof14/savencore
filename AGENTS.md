...
- logo asset / photography imagery beyond approved homepage living photoreal hero + care living carousel (D-0135–D-0152), domain thematic mastheads under `public/domain/` / `public/hub/` (D-0159–D-0160), and BioMath Core owner capability graphics under `public/domain/foundation/biomath-core/` (D-0231; still no fake deployment photography or invented KPI dashboards);
