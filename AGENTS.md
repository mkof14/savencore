...
- logo asset / photography imagery beyond approved homepage living photoreal hero + care living carousel (D-0135–D-0152), domain thematic mastheads under `public/domain/` / `public/hub/` (D-0159–D-0160), and BioMath Core illustration panels under `public/domain/foundation/biomath-core/` / `diagrams/` (D-0231/D-0234/D-0235/D-0236 — unified English owner-grade diagrams in themeable chrome; compact panel max-width; sharper HUD hero band; still no fake deployment photography or invented KPI dashboards);
