...
**Admin Platform / Social footer (D-0176) + owner super_admin path (D-0177)** — restricted `/[locale]/admin/` vertical slice (RBAC, email template library + preview, media library actions, honest marketing/tech monitoring) + configurable footer social icons; demo/owner Credentials operator always maps to `super_admin` (dev defaults + explicit prod env); public Experience Redesign UI freeze (D-0175) remains the approved public snapshot — read `docs/ADMIN_PLATFORM.md`, `docs/SITE_ASSIGNMENT.md`, `docs/SITE_AUDIT_REPORT.md`, and D-0134–D-0177.
