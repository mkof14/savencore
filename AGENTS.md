...
**Footer Install app UX (D-0224)** — Install always visible in Resources at `.site-footer__link` type (D-0223); native `beforeinstallprompt` when available; **Installed** when standalone; otherwise compact How to install panel with Close inside the panel (no bare Close link). Media downloads restored/hardened (D-0201 / D-0224). Prior D-0194–D-0223 remain in force — read `docs/ADMIN_PLATFORM.md`, `docs/SITE_ASSIGNMENT.md`, `docs/SITE_AUDIT_REPORT.md`, and D-0134–D-0224.
