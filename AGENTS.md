...
**Admin Platform expansion (D-0178) + Social footer (D-0176) + owner super_admin (D-0177)** — restricted `/[locale]/admin/` with branded email templates (SAVEN/CORE lockup + email-safe logo), polished admin shell, working roles/permissions/users/invitations/notifications/mailings (JSON store; SMTP optional / simulated otherwise); demo/owner Credentials operator always `super_admin`; public Experience Redesign UI freeze (D-0175) unchanged — read `docs/ADMIN_PLATFORM.md`, `docs/SITE_ASSIGNMENT.md`, `docs/SITE_AUDIT_REPORT.md`, and D-0134–D-0178.
