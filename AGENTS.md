...
**Admin Media traditional CMS UX + video/delete fixes (D-0185)** + simplified upload (D-0184) + Email templates + Media library (D-0183) + Home Application rename (D-0182) + Footer Legal equal columns + More hub + socials bottom row (D-0181) + Email chrome (D-0180) + Falcon/OG (D-0179) + Admin Platform (D-0176–D-0178) — Admin Media **Upload file / Upload video / Add link** tabs with visible Choose file, progress, library table + Delete; YouTube/Vimeo CSP embeds; honest Vercel storage limits; public `/[locale]/media/` Media hub in footer Company; expanded business-life email templates (D-0180 chrome); Applications leaf **Home Application**; footer Legal equal columns + **More** → `/legal/`; socials under column grid; branded email chrome; falcon on domain mastheads; OG defaults (`/brand/og-default.png`); restricted `/[locale]/admin/`; demo operator always `super_admin`; Experience Redesign UI freeze (D-0175) unchanged for heroes — read `docs/ADMIN_PLATFORM.md`, `docs/SITE_ASSIGNMENT.md`, `docs/SITE_AUDIT_REPORT.md`, and D-0134–D-0185.
