...
import { getHomeApplicationDomainContent } from "@/content/domain/build-domain-leaf";
...
export const generateMetadata = createHubGenerateMetadata(
  "/applications/home/",
  getHomeApplicationDomainContent,
);
...
export default async function Page({ params }: Props) {
  ...
  return (
    <DomainVisualPage
      locale={localeParam}
      content={getHomeApplicationDomainContent(localeParam)}
    />
  );
}
