...
import { getAiDecisionSupportDomainContent } from "@/content/domain/build-domain-leaf";
...
export const generateMetadata = createHubGenerateMetadata(
  ...
  getAiDecisionSupportDomainContent,
);
...
export default async function Page({ params }: Props) {
  ...
  return (
    <DomainVisualPage
      locale={localeParam}
      content={getAiDecisionSupportDomainContent(localeParam)}
    />
  );
}
