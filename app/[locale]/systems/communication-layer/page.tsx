...
import { getCommunicationLayerDomainContent } from "@/content/domain/build-domain-leaf";
...
export const generateMetadata = createHubGenerateMetadata(
  ...
  getCommunicationLayerDomainContent,
);
...
export default async function Page({ params }: Props) {
  ...
  return (
    <DomainVisualPage
      locale={localeParam}
      content={getCommunicationLayerDomainContent(localeParam)}
    />
  );
}
