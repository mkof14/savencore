...
import { getKnowledgeEngineDomainContent } from "@/content/domain/build-domain-leaf";
...
export const generateMetadata = createHubGenerateMetadata(
  ...
  getKnowledgeEngineDomainContent,
);
...
export default async function Page({ params }: Props) {
  ...
  return (
    <DomainVisualPage
      locale={localeParam}
      content={getKnowledgeEngineDomainContent(localeParam)}
    />
  );
}
