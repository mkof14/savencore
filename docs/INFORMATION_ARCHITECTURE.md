...
**As-built clarity pack (D-0219 / D-0220 / D-0221 / D-0225 / D-0226 / D-0227 / D-0228 / D-0229):** When `HOME_CLARITY_V1` is on (default), post-hero home adds definition, 3-step chain, compact Explore SAVEN letter showcase (logo + larger S–A–V–E–N tabs; glow contained to that band), audience fork, care-stage why-line; after carousel: BioMath Core → SAVEN actions gold callout (20 categories · 200+ services; CTA to `/foundation/biomath-core/`), compact Go deeper / Who we are (transparent BMC logo), and “what we are not”; rich closing Explore band remains (rail shows letter + pillar). Foundation BioMath Core layer carries the 20-category scope grid + 200+ services highlight (Architecture / In Development); deep page at `/foundation/biomath-core/` (D-0228/D-0229: Complete Services Catalog + count/blurb category diagram). FAQ includes dedicated BioMath coverage and reports→actions Q&As (cross-linked to the leaf). When `HOME_CLARITY_V2` is also on (default), other clarity cards stay compact with richer navy/gold/off-white grammar (D-0221). Revert density: `NEXT_PUBLIC_HOME_CLARITY_V2=false`. Revert full clarity: `NEXT_PUBLIC_HOME_CLARITY_V1=false` (see `src/config/home-clarity.ts` / D-0219 / D-0220 / D-0221 / D-0225 / D-0226 / D-0227 / D-0228).
