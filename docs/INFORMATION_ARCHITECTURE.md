...
**As-built visitor footer (D-0132 / D-0188 / D-0205–D-0213 / D-0202 / D-0216):** published destinations only, grouped by domain — Technology, **Architecture** (Systems domain depth map: Overview + published `/systems/*` leaves including Robotics Interface (footer label; full name on page); routes unchanged), Applications, Trust, Research, Labs, Company (About → `/foundation/`, Mission → `/purpose/`, Media → `/media/`), Resources (FAQ → `/faq/`, Report a Security Issue; Install app PWA control always visible under Resources — D-0213 / D-0223 / D-0224; same type as column links — D-0223; How to install panel when no native prompt — D-0224), Legal (primary links + More → `/legal/`). Desktop: **nine equal columns in one forced row** (Technology · Architecture · Labs · Applications · Trust · Research · Company · Resources · Legal) — D-0209; supersedes D-0205 stacked five-column map; accordion below 860px; D-0208 compress labels / Robotics Interface footer label remain; D-0210 footer language hover accent; D-0211 larger links + wider gaps + medical disclaimer; **D-0212** footer form removed (Contact only), disclaimer between socials and copyright, denser link lists, three-line slogan lockup; **D-0213** Install app relocated from bottom utilities into Resources (smaller type); Admin Platform follows site light/dark + logo. Full technical leaf lists live here as the Layer 2 depth map; primary header stays short. No Coming Soon badges in the visitor footer. Target taxonomy below remains the longer-term IA inventory; do not invent unpublished leaves as live links.
