...
1. **Hero** (D-0261) — brand copy + **living photoreal help collage** (`HeroLivingMedia`). Particle morph retired (D-0267). Lab hub `/lab/` shows **one** light dual-format video splash **embedded into the page surface** with soft feathered edges (D-0266 / D-0267 / D-0268 / D-0269 / D-0270 / D-0271 / D-0272 — re-cut skips in-file letterbox intro + center zoom-crop; clear picture without grain/heavy vignette/grade; tasteful text overlay + glass-light links to published routes; chapter ticks; light side ambient; scroll-linked caption; optional sound/mute; strong parallax + softened cursor; Ken Burns; no hard video box or editorial frame; depth blur duplicate removed; not on public home).
