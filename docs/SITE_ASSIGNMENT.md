...
1. **Particle morph stage** (D-0255 / D-0258 / D-0259) — one full-bleed **16:9 cinematic frame at a time** via WebGL2 (650000 points × 4 scenes: HUMAN + INTERFACE rebaked D-0259 for clean flame logo / dense human; ROBOT + WATER from HTML; ~24s snappy loop; never the vertical 5-panel reference sheet; single-frame HUMAN poster; reduced-motion poster; `?v=d0259`)
2. **Hero copy** — brand, hero line, one breath sentence, three build pillars, tagline, footer cue (below particle stage; living collage superseded as upper media)
