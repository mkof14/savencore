...
1. **Particle morph stage** (D-0255 / D-0256) — full-bleed WebGL2 artboard (650000 points × 5 scenes: HUMAN → LOGO → TOUCH → WATER → RETURN; ~24.5s snappy loop; dense blue/orange aesthetic; no text on canvas; bright load poster; reduced-motion poster)
