...
2. **Clarity pack** (D-0219 / D-0220 / D-0221 / D-0225 / D-0226 / D-0227; flags `HOME_CLARITY_V1` + `HOME_CLARITY_V2`, default on) — visual What is SAVEN · **BioMath Core → SAVEN actions gold callout** (20 categories · 200+ services) · 3-step chain · **Explore SAVEN** compact cinematic letter showcase (logo + larger S–A–V–E–N tabs) · audience fork; after carousel: what we are not. Set `HOME_CLARITY_V1` false to restore pre-D-0219 order; set `HOME_CLARITY_V2` false to keep V1 blocks with pre-density layout.
