...
**As-built footer (D-0181–D-0213 / D-0202):** Technology · **Architecture** (Systems leaves + SAVEN Robotics Interface; routes stay `/systems/*`) · Labs · Applications · Trust · Research (Overview + Areas + Notes) · Company (About → `/foundation/`, **BioMath Core → `/foundation/biomath-core/`**, Mission → `/purpose/`, Investors, Investor Contact, Media → `/media/`, Contact → `/contact/`, Roadmap → `/roadmap/`) · Resources (FAQ → `/faq/`, Report a Security Issue; **Install app** PWA control always visible under this column — D-0213 / D-0223 / D-0224; **same type as column links** (`0.6875rem` / `0.75rem`) — D-0223; native prompt or How to install panel with Close inside panel — D-0224; supersedes D-0222 shrink) · Legal (primary links + More → `/legal/` hub; interim owner-authorized policies — D-0216; counsel review still recommended). Desktop layout: **nine equal columns in one forced row** — Technology · Architecture · Labs · Applications · Trust · Research · Company · Resources · Legal (D-0209; supersedes D-0205 stacked five-column map / D-0199 wrap issues; accordion below 860px). Care stage Application CTAs on large slides (D-0209). Footer language/theme utility hover accent (D-0210). D-0211: larger footer link type + wider column gaps; protective medical disclaimer; navy-tile favicon `?v=211`. **D-0212:** Get in touch form removed from footer (Contact page only); medical disclaimer between socials and copyright bar; denser link-list rhythm; three-line slogan navy/gold lockup. **D-0213:** Admin follows site light/dark + logo + richer accents; Install app relocated from bottom utilities bar into Resources. D-0208 socials/bar/carousel thumbs + Robotics Interface footer label remain. Theme chrome (D-0207/D-0211): light cool off-white (`#e6e6e9` / `#eeeeef`); dark soft gray-blue field (`#1c1f26` / `#252830`) — not pure white / deep template navy. Header hubs (≤7): Labs, **Systems**, Applications, Technology, Research, Trust, Investors (Purpose remains via footer Mission).
