...
1. **Hero** (D-0261) — brand copy + **living photoreal help collage** (`HeroLivingMedia`; pre–particle layout). Particle morph is **not** on the public home — Lab experiments via `/lab/` → `/preview/particle-hero/` (D-0264 human+waves bake; older home bins may remain unused).
