...
1. **Particle morph stage** (D-0255–D-0260) — **16:9** WebGL2 morph (~68svh stage, not full-viewport — D-0260); 650000 points; INTERFACE from official `saven-logo.png`; sharper HUMAN + living hold micro-morphs (HUMAN/ROBOT/WATER ↔ alt buffers); ROBOT/WATER HTML primaries; never the 5-panel sheet; HUMAN poster; `?v=d0260`
