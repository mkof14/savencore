...
1. **Particle morph stage** (D-0255 / D-0256 / D-0257) — one full-bleed **16:9 cinematic frame at a time** via WebGL2 (650000 points × 5 scenes: HUMAN → LOGO → TOUCH → WATER → RETURN; ~24.5s snappy loop; dense blue/orange; never the vertical 5-panel reference sheet; single-frame load poster; reduced-motion poster)
