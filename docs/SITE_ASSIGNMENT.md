...
1. **Hero** (D-0261) — brand copy + **living photoreal help collage** (`HeroLivingMedia`). Particle morph retired (D-0267). Lab hub `/lab/` shows **one** light dual-format video splash with cinematic + editorial treatment (D-0266 / D-0267 / D-0268 / D-0269 — designed cut, optional sound/mute, parallax, cursor light, frame chrome; depth blur duplicate removed; not on public home).
