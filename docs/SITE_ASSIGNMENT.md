...
1. **Hero** (D-0261) — brand copy + **living photoreal help collage** (`HeroLivingMedia`; pre–particle layout). Particle morph is **not** on the public home — experiments only at `/preview/particle-hero/` (D-0255–D-0260 assets retained for that preview).
