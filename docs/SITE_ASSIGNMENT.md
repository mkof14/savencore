...
1. **Hero** (D-0261) — brand copy + **living photoreal help collage** (`HeroLivingMedia`; pre–particle layout). Particle morph is **not** on the public home — Lab experiments via `/lab/` → `/preview/particle-hero/` (D-0265 Understanding → Assistance → Care story; older home bins may remain unused). Lab hub `/lab/` may show a video splash band (D-0266 GWR MVP; ~14MB; not home).
