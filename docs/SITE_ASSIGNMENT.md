...
1. **Hero** (D-0261) — brand copy + **living photoreal help collage** (`HeroLivingMedia`). Particle morph retired (D-0267). Lab hub `/lab/` shows **one** light dual-format video splash with cinematic treatment (D-0266 / D-0267 / D-0268; depth blur duplicate removed; not on public home).
