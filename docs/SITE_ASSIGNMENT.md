...
1. **Hero** (D-0261) — brand copy + **living photoreal help collage** (`HeroLivingMedia`). Particle morph retired (D-0267). Lab hub `/lab/` shows **one** light dual-format full-bleed video splash with amplified cinematic treatment (D-0266 / D-0267 / D-0268 / D-0269 / D-0270 — re-cut, optional sound/mute, strong parallax + cursor spotlight, Ken Burns / vignette / grain / grade; editorial frame removed; depth blur duplicate removed; not on public home).
