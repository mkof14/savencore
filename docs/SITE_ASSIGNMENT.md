...
1. **Hero** (D-0261) — brand copy + **living photoreal help collage** (`HeroLivingMedia`). Particle morph retired (D-0267). Lab hub `/lab/` shows **one** light dual-format video splash **embedded into the page surface** with **symmetric** soft feathered edges (D-0266 / D-0267 / D-0268 / D-0269 / D-0270 / D-0271 / D-0272 / D-0273 / D-0274 / D-0275 / D-0276 — opening dots-person from master t=0 restored (D-0276 supersedes aggressive letterbox intro skip); **original 16:9 framing** without center zoom-crop; clear picture without grain/heavy vignette/grade; equal top/bottom + left/right page-background blend; tasteful text overlay + glass-light links to published routes; **clickable chapter ticks** that jump to scene times; **timed captions** Understanding → Assistance → Care; light side ambient; scroll-linked caption fade; optional sound/mute; light parallax + softened cursor; gentle Ken Burns; no hard video box or editorial frame; depth blur duplicate removed; not on public home).
