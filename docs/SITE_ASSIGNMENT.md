...
2. **Clarity pack** (D-0219 / D-0220 / D-0221 / D-0225 / D-0226 / D-0227 / D-0228 / D-0229 / D-0230 / D-0231 / D-0232 / D-0233 / D-0234 / D-0235 / D-0236 / D-0237 / D-0238 / D-0239; flags `HOME_CLARITY_V1` + `HOME_CLARITY_V2`, default on) — visual What is SAVEN · 3-step chain · **Explore SAVEN** compact cinematic letter showcase (logo + larger S–A–V–E–N tabs) · audience fork; after carousel: **one merged BioMath bridge** (Who we are / BioMath Core → SAVEN / Human Data Model continuous context / 20 categories · 200+ services; smaller transparent BMC mark; CTA → `/foundation/biomath-core/`) · what we are not. BioMath Core leaf (D-0239): unified English owner-grade illustration series (cache-busted Engine EN), **harmonious smaller diagram panels** (~40rem / Black Box ~34rem) with tighter rhythm, sharper HUD hero band + **Environments-like themeable category artboard panels** (larger titles; **no per-card service counts**) + Black Box **sensitive personal data storage / protection architecture intent** with soft cross-links to published `/trust/privacy/`, `/trust/security/`, and `/legal/privacy-policy/` (not Operational guarantees) + light on-page TOC + Trust paths in Continue exploring; supersedes plain CSS count cards of D-0232 for category presentation; refines D-0234–D-0238. Set `HOME_CLARITY_V1` false to restore pre-D-0219 order; set `HOME_CLARITY_V2` false to keep V1 blocks with pre-density layout.
