...
- Icons: `public/favicon.svg`, `favicon.ico` (16/32/48/64), `favicon-16/32/48.png`, `public/icons/icon-64.png`, `icon-192.png`, `icon-512.png`, `icon-512-maskable.png`, `apple-touch-icon.png` (D-0204)
