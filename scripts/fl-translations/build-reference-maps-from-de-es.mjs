...
const DE_FR = [
  ...
  ["SAVEN Core baut KI, Robotik, autonome Systeme und Ingenieurtechnologien, die in realen Umgebungen arbeiten sollen.", "SAVEN Core construit l'IA, la robotique, les systèmes autonomes et les technologies d'ingénierie destinées à opérer dans des environnements réels."],
