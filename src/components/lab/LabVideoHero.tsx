...
/**
 * Lab splash video band (D-0266–D-0269) — owner preview only; not on public home.
 * Single looping video + poster; cinematic CSS; editorial frame; parallax; cursor light;
 * mute/unmute (default muted). No duplicated depth/blur video layer (D-0268).
 */
export function LabVideoHero({ copy }: { copy: LabVideoHeroCopy }) {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const y = Math.max(-16, Math.min(16, t * -22));
  ...
  return (
    <div
      ...
      className={[
        ...
        .join(" ")}
    >
      <div className="site-lab-video-hero__shell">
        <span className="site-lab-video-hero__corner site-lab-video-hero__corner--tl" aria-hidden="true" />
        <span className="site-lab-video-hero__corner site-lab-video-hero__corner--tr" aria-hidden="true" />
        <span className="site-lab-video-hero__corner site-lab-video-hero__corner--bl" aria-hidden="true" />
        <span className="site-lab-video-hero__corner site-lab-video-hero__corner--br" aria-hidden="true" />
        ...
        <div className="site-lab-video-hero__frame">
          ...
          <div className="site-lab-video-hero__chrome">
            <div className="site-lab-video-hero__chrome-top">
              <p className="site-lab-video-hero__frame-eyebrow">{copy.frameEyebrow}</p>
              <span className="site-lab-video-hero__chip">{copy.watchChip}</span>
            </div>
            <div className="site-lab-video-hero__chrome-bottom">
