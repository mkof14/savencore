...
export const homeContentHe: HomeContent = {
  hero: {
    ...
    explanation:
      "SAVEN Core מחבר בין הבנה אנושית, טכנולוגיה, מערכות והקשרים מהעולם האמיתי — בתוך גבולות ברורים.",
    status:
      "המצב כיום: עבודת ארכיטקטורה ופיתוח. זו אינה פלטפורמת מוצרים מוגמרת.",
  },
  architectureChain: [
