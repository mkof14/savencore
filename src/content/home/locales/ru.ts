...
export const homeContentRu: HomeContent = {
  hero: {
    ...
    explanation:
      "SAVEN Core объединяет понимание человека, технологии, системы и реальные среды — в чётко обозначенных границах.",
    status:
      "Текущий статус: архитектурная и инженерная разработка. Это не готовая продуктовая платформа.",
  },
  architectureChain: [
    { id: "human", label: "Люди" },
