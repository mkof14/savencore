...
export const physicalWorldHomeAr: PhysicalWorldHomeContent = {
  brand: "SAVEN Core",
  heroLine: "ذكاء للعالم المادي.",
  oneBreath:
    "نستخدم ونحسّن الذكاء الاصطناعي مع الروبوتات للعمل في العالم الحقيقي — حتى تستطيع الآلات أن تستشعر وتتحرك وتساعد تحت إشراف الإنسان.",
  builds: ["الذكاء الاصطناعي", "الروبوتات", "الأنظمة المستقلة"],
  ...
  clarity: {
    ...
    biomathBridge: {
      ...
      body: "BioMath Core هو أساس نموذج البيانات البشرية — سياق مستمر يجمع ويهيكل البيانات البشرية المصرّح بها، ويشكّل التقارير والاستنتاجات التي تصوغ إجراءات SAVEN للمستوى التالي تحت السيطرة البشرية. تبقى الحالة Architecture / In Development.",
