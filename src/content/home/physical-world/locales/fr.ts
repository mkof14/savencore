...
export const physicalWorldHomeFr: PhysicalWorldHomeContent = {
  brand: "SAVEN Core",
  heroLine: "L’intelligence pour des robots qui aident les personnes",
  oneBreath:
    "SAVEN développe des technologies intelligentes d’assistance humaine pour la robotique — perception, mouvement, personnalisation, sécurité et interaction humaine, afin que les systèmes robotiques soutiennent les personnes dans le monde physique.",
  builds: ["Intelligence artificielle", "Robotique", "Assistance humaine"],
  ...
  clarity: {
    ...
    biomathBridge: {
      ...
      body: "L'assistance robotique devient plus utile lorsque la technologie peut comprendre la personne — pas seulement la tâche. Le Human Data Model reste la représentation structurée plus large des données humaines. BioMath Core peut fournir des analyses et rapports spécialisés que SAVEN peut utiliser pour une interaction plus personnalisée — sous permissions et contrôles de confidentialité. BioMath Core ne remplace pas le Human Data Model.",
