...
export const physicalWorldHomeUk: PhysicalWorldHomeContent = {
  brand: "SAVEN Core",
  heroLine: "Інтелект для роботів, які допомагають людям",
  oneBreath:
    "SAVEN розробляє інтелектуальні технології людської допомоги для робототехніки — поєднуючи сприйняття, рух, персоналізацію, безпеку та взаємодію з людиною, щоб роботизовані системи підтримували людей у фізичному світі.",
  builds: ["Штучний інтелект", "Робототехніка", "Людська допомога"],
  ...
  clarity: {
    ...
    biomathBridge: {
      ...
      body: "Роботизована допомога стає кориснішою, коли технологія може зрозуміти людину — а не лише завдання. Human Data Model лишається ширшим структурованим представленням людських даних. BioMath Core може надавати спеціалізований аналіз і звіти, які SAVEN може використовувати для більш персоналізованої взаємодії — за дозволами та контролем конфіденційності. BioMath Core не замінює Human Data Model.",
      scopeLine: "Охоплення моделі: 20 категорій · 200+ сервісів — не каталог Operational.",
