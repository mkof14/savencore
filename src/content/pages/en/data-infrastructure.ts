...
export const dataInfrastructurePageContent: DataInfrastructurePageContent = {
  ...
  knowledgeEngine: [
    ...
    "This section describes the architectural relationship with the Knowledge Engine.",
  ],
  ...
  futureIntro:
    "Topics below are drawn from the Data Infrastructure entry in the shared registry and provide context for related architecture.",
