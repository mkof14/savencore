...
export const humanDataPageContent: HumanDataPageContent = {
  ...
  executiveSummary: [
    ...
    "BioMath Core may use or contribute to Human Data through that model across 20 categories and 200+ services as model scope; its reports and conclusions may inform SAVEN assistance architecture under human control — not diagnosis, prescribing, or selling medicines. BioMath Core does not replace the Human Data Model.",
  ],
