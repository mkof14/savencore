...
export const uiAr: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "مُطبَّق على هذا الشريط: فيديو خفيف واحد بصيغتين (WebM + MP4، اختيار للجوال)، تكبير Ken Burns، تظليل ناعم، تدرج سفلي نحو الصفحة، حبيبات فيلم دقيقة، تدرج لوني خفيف، وتلاشٍ سلس عند الجاهزية. زوايا مستقيمة؛ بلا كروم نيون. مع تقليل الحركة يظهر الملصق فقط.",
    videoEffectsIdeas:
