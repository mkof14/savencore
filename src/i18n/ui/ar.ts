...
export const uiAr: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "مُطبَّق على هذا الشريط (بعرض كامل بلا إطار صورة): فيديو خفيف بصيغتين (WebM + MP4، اختيار للجوال) مع قصّة جديدة (~7.2ث بسرعة خفيفة 1.05×) وصوت اختياري (يبدأ مكتومًا)، زر كتم، تسمية رفيعة تحت الفيديو، تقدّم الحلقة، اختلاف منظر قوي عند التمرير (±~64px مع تكبير)، ضوء مؤشر واضح على سطح المكتب، تكبير Ken Burns حتى ~1.12، تظليل واضح، حبيبات، تدرج لوني وتلاشٍ. زوايا مستقيمة؛ بلا نيون. مع تقليل الحركة تُخفَّف التأثيرات ويظهر الملصق.",
    videoEffectsIdeas:
