...
export const uiAr: UiMessages = {
  ...
  legal: {
    ...
    draftNote: "سياسات الموقع لممارسات المعلومات وشروط الاستخدام. للاستفسار: info@savencore.com.",
    indexTitle: "قانوني",
    indexLead: "الخصوصية والشروط وملفات تعريف الارتباط وإمكانية الوصول والأمن والإشعارات ذات الصلة للموقع العام. توضح تفضيلات ملفات تعريف الارتباط أنه لا يوجد CMP موافقة نشط — استخدم إعدادات المتصفح أو تواصل معنا.",
  },
