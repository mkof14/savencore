...
export const uiAr: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "مُطبَّق على هذا الشريط: فيديو خفيف بصيغتين (WebM + MP4، اختيار للجوال)، تكبير Ken Burns، تظليل ناعم، تدرج سفلي نحو الصفحة، حبيبات فيلم دقيقة، تدرج لوني خفيف، طبقة عمق ضبابية اختيارية (سطح المكتب)، وتلاشٍ سلس عند الجاهزية. زوايا مستقيمة؛ بلا كروم نيون. مع تقليل الحركة يظهر الملصق فقط.",
    videoEffectsIdeas:
      "أفكار مستقبلية (غير منشورة): اختلاف منظر عند التمرير، ضوء مؤشر تفاعلي، قطع فصول / قائمة مقاطع، صوت خفيف مع كتم، HDR/AV1 عند اتساع الدعم.",
