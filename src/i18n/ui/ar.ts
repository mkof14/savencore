...
export const uiAr: UiMessages = {
  ...
  lab: {
    ...
    particleHeroTitle: "الروبوتات تساعد الناس",
    particleHeroLead:
      "تجربة قصة بالجسيمات: SAVEN يساعد على التمكين من الفهم، ثم المساعدة الجسدية، ثم لحظة رعاية. اللوحة صور فقط. الصفحة الرئيسية تبقى كولاج الصور.",
    beatsLabel: "إيقاعات القصة",
    beatUnderstanding: "الفهم",
    beatUnderstandingNote: "سياق الإنسان والطاقة — جانب النظام الذي يدعم الرعاية.",
    beatAssistance: "المساعدة",
    beatAssistanceNote: "ذراع روبوتية تقدم الماء — مساعدة جسدية تحت سيطرة الإنسان.",
    beatCare: "الرعاية",
    beatCareNote: "لحظة مساعدة بشرية الشكل — الروبوتات تساعد الناس حيث تحدث الحياة.",
