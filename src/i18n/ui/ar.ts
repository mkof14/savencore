...
export const uiAr: UiMessages = {
  ...
  admin: {
    ...
    mediaNote:
      "التخزين السحابي الدائم مرحلة لاحقة. على Vercel نظام الملفات غير دائم — قد تكون الرفوعات غير متاحة أو مؤقتة. محليًا: storage/admin-media/.",
    mediaAddHeading: "إضافة محتوى",
    mediaAddLead: "ملف أو رابط فيديو أو رابط — حقول أقل ونشر أسرع.",
    mediaTabFile: "ملف",
    mediaTabVideo: "فيديو",
    mediaTabLink: "رابط",
    ...
    mediaAcceptedTypes:
      "PDF وDOC/DOCX وPPT/PPTX وKEY وMP4/WebM وصور · حتى 40 ميجابايت",
    mediaBrowse: "تصفح الملفات",
    mediaUploadNow: "رفع",
    ...
    mediaVideoUrlPlaceholder: "YouTube أو Vimeo أو رابط MP4/WebM مباشر",
    mediaVideoTitlePlaceholder: "العنوان (اختياري — من الرابط)",
    mediaVideoOrUpload: "أو ارفع ملف فيديو",
    mediaVideoPreview: "معاينة مباشرة",
    ...
    mediaEmptyLibrary: "أسقط فيديو أو PDF أو الصق رابطًا",
