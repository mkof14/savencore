...
export const uiDe: UiMessages = {
  ...
  admin: { ...uiEn.admin, brandTitle: "SAVEN Admin", navLabel: "Admin-Navigation", statusInDevelopment: "In Entwicklung", eyebrow: "Admin-Plattform", backToSite: "Zur Website", signOut: "Abmelden", navDashboard: "Übersicht", navEmailTemplates: "E-Mail-Vorlagen", navMedia: "Medienbibliothek", navMarketing: "Marketing-Tools", navMonitoring: "Technische Überwachung", openSection: "Öffnen", dashboardTitle: "Site-Administration", emailTitle: "E-Mail-Vorlagen", mediaTitle: "Medienbibliothek", marketingTitle: "Marketing-Tools", monitoringTitle: "Technische Überwachung", actionPreview: "Vorschau", actionCopy: "Kopieren", actionPrint: "Drucken", actionShare: "Teilen", actionDownload: "Download", actionPdf: "PDF" },
  auth: {
