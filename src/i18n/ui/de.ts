...
export const uiDe: UiMessages = {
  ...
  contact: {
    ...
    submit: "In E-Mail-App öffnen",
    success: "Ihre E-Mail-App sollte sich mit der fertigen Nachricht öffnen.",
