...
export const uiEs: UiMessages = {
  ...
  footerContact: {
    heading: "Contactar",
    lede: "Escriba a info@savencore.com — colaboraciones, diálogo de investigación, consulta de inversores o preguntas generales.",
