...
export const uiEs: UiMessages = {
  ...
  nav: { home: "Inicio", technology: "Tecnología", systems: "Sistemas", applications: "Aplicaciones", trust: "Confianza", research: "Investigación", purpose: "Propósito", foundation: "Fundamentos", labs: "Laboratorios", investors: "Inversores", partners: "Socios", business: "Negocios", signIn: "Iniciar sesión / Registrarse" },
  navEntries: { ...uiEn.navEntries, "technology-overview": "Tecnología", "technology-human-data": "Datos humanos", "technology-human-data-model": "Modelo de datos humanos", "technology-data-infrastructure": "Infraestructura de datos", "technology-interoperability": "Interoperabilidad", "technology-privacy": "Privacidad", "technology-security": "Seguridad", "technology-artificial-intelligence": "Inteligencia artificial", "technology-automation": "Automatización", "technology-robotics": "Robótica", "systems-overview": "Sistemas", "systems-knowledge-engine": "Motor de conocimiento", "systems-ai-decision-support": "Apoyo a la decisión con IA", "systems-safety-layer": "Capa de seguridad", "systems-communication-layer": "Capa de comunicación", "systems-clinical-interfaces": "Interfaces clínicas", "systems-robotics-layer": "Capa de robótica", "systems-drone-systems": "Sistemas de drones", "systems-saven-robotics-interface": "Interfaz de robótica SAVEN", "applications-overview": "Aplicaciones", "applications-healthcare": "Atención sanitaria", "applications-home": "Aplicación del hogar", "applications-hospitals": "Hospitales", "applications-emergency": "Emergencias", "applications-industrial": "Industria", "applications-government": "Gobierno", "applications-agriculture": "Agricultura", "applications-research-applications": "Aplicaciones de investigación", "trust-overview": "Confianza", "trust-privacy": "Privacidad", "trust-security": "Seguridad", "trust-safety": "Protección", "trust-human-oversight": "Supervisión humana", "trust-transparency": "Transparencia", "trust-ethics": "Ética y uso responsable", "trust-limitations": "Limitaciones", "footer-technology-overview": "Resumen", "footer-systems-overview": "Resumen", "footer-applications-overview": "Resumen", "footer-trust-overview": "Resumen", "footer-applications-research": "Investigación", "footer-trust-ethics": "Ética", "footer-company-about": "Acerca de",
    ...
    "footer-resources-faq": "Preguntas frecuentes", "footer-company-sitemap": "Mapa del sitio", "footer-resources-security-issue": "Incidente de seguridad", "sign-in": "Iniciar sesión / Registrarse", "footer-company-contact": "Contacto", "footer-company-investors": "Inversores", "footer-company-media": "Medios", "footer-labs-overview": "Resumen", "footer-labs-saven-robotics-lab": "SAVEN Robotics Lab", "footer-labs-internal-future-lab": "Future Lab", "footer-systems-saven-robotics-interface": "Interfaz de robótica", "footer-legal-privacy-policy": "Política de privacidad", "footer-legal-terms-of-use": "Términos de uso", "footer-legal-disclaimer": "Descargo de responsabilidad", "footer-company-partners": "Socios", "footer-company-business": "Negocios", "footer-business-market-context": "Contexto de mercado", "footer-business-human-data": "Datos humanos", "footer-business-saven-physical-systems": "SAVEN y sistemas físicos", "footer-business-where-value-is-created": "Dónde se crea valor", "footer-business-applications": "Aplicaciones de negocio", "footer-business-why-the-timing-matters": "Por qué importa el momento", "footer-business-what-we-know-today": "Lo que sabemos hoy", "footer-legal-overview": "Legal", "trust-responsible-development": "Desarrollo responsable", "footer-legal-cookie-policy": "Política de cookies", "footer-legal-cookie-preferences": "Preferencias de cookies", "footer-legal-accessibility-statement": "Declaración de accesibilidad", "footer-legal-security": "Seguridad", "footer-legal-responsible-ai": "IA responsable", "footer-legal-medical-disclaimer": "Aviso médico", "footer-legal-research-disclaimer": "Aviso de investigación", "footer-legal-intellectual-property": "Propiedad intelectual", "footer-legal-trademark-notice": "Aviso de marcas", "footer-legal-copyright": "Aviso de copyright", "footer-legal-data-rights": "Derechos sobre los datos", "footer-legal-regional-privacy-rights": "Derechos regionales de privacidad", "footer-legal-do-not-sell-or-share": "No vender ni compartir", "footer-legal-legal-notices": "Avisos legales", "footer-trust-more": "Más…", "footer-legal-more": "Más…"},
  footer: { ...uiEn.footer, copyrightLabel: "Copyright", themeToLight: "Cambiar a tema claro", themeToDark: "Cambiar a tema oscuro", signIn: "Iniciar sesión / Registrarse", admin: "Admin", technology: "Tecnología", systems: "Sistemas", architecture: "Arquitectura", applications: "Aplicaciones", trust: "Confianza", trustLegal: "Confianza · Legal", research: "Investigación", labs: "Laboratorios", about: "Acerca de SAVEN Core", resources: "Recursos", company: "Empresa", legal: "Legal", more: "Más", sectionOpen: "Abrir", sectionClose: "Cerrar", contact: "Contacto", plannedNote: "", comingSoon: "", copyright: "Copyright © 2026 SAVEN Core. Todos los derechos reservados.", copyrightShort: "© SAVEN Core", rightsReserved: "Todos los derechos reservados.", privacy: "Privacidad", terms: "Términos", disclaimer: "Descargo de responsabilidad", responsibleDevelopment: "Desarrollo responsable", developmentNote: "SAVEN es una iniciativa de desarrollo tecnológico. Parte del contenido muestra direcciones de investigación, conceptos de desarrollo y posibles aplicaciones futuras.", cookies: "Cookies", theme: "Tema", themeLight: "Claro", themeDark: "Oscuro", version: "Versión", tagline: "Datos humanos.\nSistemas conectados.\nTecnología responsable." },
  ...
  lab: { ...uiEn.lab,
    ...
    videoCaptionSiteUnderstanding: "Comprensión — las personas y el nombre entran en vista.",
    videoCaptionSiteAssistance: "Asistencia — apoyo pensado para entornos cotidianos.",
    videoCaptionSiteCare: "Cuidado — sistemas orientados al cuidado humano a lo largo de la vida.",
    ...
    lede: "Todas las páginas publicadas de este sitio, agrupadas por sección.",
  },
  medicalDisclaimer: {
    short:
  ...
  contact: { ...uiEn.contact,
    ...
    inquiryRobotics: "Asociación en robótica",
    inquiryTechnology: "Asociación tecnológica",
    inquiryResearch: "Colaboración de investigación",
    inquiryRehab: "Rehabilitación / investigación clínica",
    inquiryCare: "Vivienda para mayores / cuidado",
    inquiryInvestor: "Consulta de inversores",
    inquiryMedia: "Medios",
    subjectLabel: "Asunto (opcional)",
    messageLabel: "Mensaje",
    medicalNote:
      "No envíe información médica confidencial a través de este formulario.",
    ...
    error: "Complete nombre, correo, tipo de consulta y mensaje.",
    fallbackNote:
