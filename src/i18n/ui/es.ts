...
export const uiEs: UiMessages = {
  ...
  auth: {
    ...
    back: "Volver",
    configureTitle: "Configuración necesaria",
    configureGoogle:
      "El inicio de sesión con Google aún no está configurado. Añada GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET y AUTH_SECRET al entorno.",
    configurePassword:
      "El inicio de sesión con correo y contraseña aún no está configurado. Añada AUTH_SECRET, AUTH_DEMO_EMAIL y AUTH_DEMO_PASSWORD para una cuenta de operador de prueba. Una base de usuarios completa llegará más adelante.",
    configureCredentials:
      "El inicio de sesión con Google aún no está configurado. Añada GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET y AUTH_SECRET al entorno.",
    invalidCredentials: "Correo o contraseña no válidos.",
    operatorNote:
      "El inicio con contraseña usa una sola cuenta de operador basada en variables de entorno solo para pruebas de lanzamiento — no es un registro público de usuarios.",
  ...
  hub: { related: "Continuar", explore: "Explorar", areas: "Áreas", what: "Qué es", why: "Por qué importa", next: "Adónde ir", deeper: "Más detalle" },
  pwa: {
