...
export const uiFr: UiMessages = {
  ...
  nav: { home: "Accueil", technology: "Technologie", systems: "Systèmes", applications: "Applications", trust: "Confiance", research: "Recherche", purpose: "Raison d’être", foundation: "Fondations", labs: "Laboratoires", investors: "Investisseurs", partners: "Partenaires", business: "Business", signIn: "Connexion / Inscription" },
  navEntries: { ...uiEn.navEntries, "technology-overview": "Technologie", "technology-human-data": "Données humaines", "technology-human-data-model": "Modèle de données humaines", "technology-data-infrastructure": "Infrastructure de données", "technology-interoperability": "Interopérabilité", "technology-privacy": "Confidentialité", "technology-security": "Sécurité", "technology-artificial-intelligence": "Intelligence artificielle", "technology-automation": "Automatisation", "technology-robotics": "Robotique", "systems-overview": "Systèmes", "systems-knowledge-engine": "Moteur de connaissances", "systems-ai-decision-support": "Aide à la décision par IA", "systems-safety-layer": "Couche de sécurité", "systems-communication-layer": "Couche de communication", "systems-clinical-interfaces": "Interfaces cliniques", "systems-robotics-layer": "Couche robotique", "systems-drone-systems": "Systèmes de drones", "systems-saven-robotics-interface": "Interface robotique SAVEN", "applications-overview": "Applications", "applications-healthcare": "Santé", "applications-home": "Application domicile", "applications-hospitals": "Hôpitaux", "applications-emergency": "Urgences", "applications-industrial": "Industrie", "applications-government": "Secteur public", "applications-agriculture": "Agriculture", "applications-research-applications": "Applications de recherche", "trust-overview": "Confiance", "trust-privacy": "Confidentialité", "trust-security": "Sécurité", "trust-safety": "Protection", "trust-human-oversight": "Supervision humaine", "trust-transparency": "Transparence", "trust-ethics": "Éthique et usage responsable", "trust-limitations": "Limites", "footer-technology-overview": "Aperçu", "footer-systems-overview": "Aperçu", "footer-applications-overview": "Aperçu", "footer-trust-overview": "Aperçu", "footer-applications-research": "Recherche", "footer-trust-ethics": "Éthique", "footer-company-about": "À propos",
    ...
    "footer-resources-faq": "FAQ", "footer-company-sitemap": "Plan du site", "footer-resources-security-issue": "Incident de sécurité", "sign-in": "Connexion / Inscription", "footer-company-contact": "Contact", "footer-company-investors": "Investisseurs", "footer-company-media": "Médias", "footer-labs-overview": "Aperçu", "footer-labs-saven-robotics-lab": "SAVEN Robotics Lab", "footer-labs-internal-future-lab": "Future Lab", "footer-systems-saven-robotics-interface": "Interface robotique", "footer-legal-privacy-policy": "Politique de confidentialité", "footer-legal-terms-of-use": "Conditions d'utilisation", "footer-legal-disclaimer": "Avertissement", "footer-company-partners": "Partenaires", "footer-company-business": "Business", "footer-business-market-context": "Contexte de marché", "footer-business-human-data": "Données humaines", "footer-business-saven-physical-systems": "SAVEN et systèmes physiques", "footer-business-where-value-is-created": "Où la valeur est créée", "footer-business-applications": "Applications business", "footer-business-why-the-timing-matters": "Pourquoi le moment compte", "footer-business-what-we-know-today": "Ce que nous savons aujourd’hui", "footer-legal-overview": "Mentions légales", "trust-responsible-development": "Développement responsable", "footer-legal-cookie-policy": "Politique relative aux cookies", "footer-legal-cookie-preferences": "Préférences de cookies", "footer-legal-accessibility-statement": "Déclaration d'accessibilité", "footer-legal-security": "Sécurité", "footer-legal-responsible-ai": "IA responsable", "footer-legal-medical-disclaimer": "Avertissement médical", "footer-legal-research-disclaimer": "Avertissement recherche", "footer-legal-intellectual-property": "Propriété intellectuelle", "footer-legal-trademark-notice": "Avis sur les marques", "footer-legal-copyright": "Avis de copyright", "footer-legal-data-rights": "Droits relatifs aux données", "footer-legal-regional-privacy-rights": "Droits régionaux à la vie privée", "footer-legal-do-not-sell-or-share": "Ne pas vendre ni partager", "footer-legal-legal-notices": "Mentions légales", "footer-trust-more": "Plus…", "footer-legal-more": "Plus…"},
  footer: { ...uiEn.footer, copyrightLabel: "Copyright", themeToLight: "Passer au thème clair", themeToDark: "Passer au thème sombre", signIn: "Connexion / Inscription", admin: "Admin", technology: "Technologie", systems: "Systèmes", architecture: "Architecture", applications: "Applications", trust: "Confiance", trustLegal: "Confiance · Droit", research: "Recherche", labs: "Laboratoires", about: "À propos de SAVEN Core", resources: "Ressources", company: "Entreprise", legal: "Mentions légales", more: "Plus", sectionOpen: "Ouvrir", sectionClose: "Fermer", contact: "Contact", plannedNote: "", comingSoon: "", copyright: "© 2026 SAVEN Core. Tous droits réservés.", copyrightShort: "© SAVEN Core", rightsReserved: "Tous droits réservés.", privacy: "Confidentialité", terms: "Conditions", disclaimer: "Avertissement", responsibleDevelopment: "Développement responsable", developmentNote: "SAVEN est une initiative de développement technologique. Certains contenus présentent des directions de recherche, des concepts de développement et de possibles applications futures.", cookies: "Cookies", theme: "Thème", themeLight: "Clair", themeDark: "Sombre", version: "Version", tagline: "Données humaines.\nSystèmes connectés.\nTechnologie responsable." },
  ...
  lab: { ...uiEn.lab,
    ...
    eyebrow: "Navigation",
    title: "Plan du site",
    lede: "Toutes les pages publiées de ce site, regroupées par section.",
  },
  medicalDisclaimer: {
    short:
  ...
  contact: { ...uiEn.contact,
    ...
    roleLabel: "Fonction",
    emailLabel: "E-mail",
    websiteLabel: "Site de l’entreprise (facultatif)",
    inquiryTypeLabel: "Type de demande",
    inquiryGeneral: "Demande générale",
    inquiryRobotics: "Partenariat robotique",
    inquiryTechnology: "Partenariat technologique",
    inquiryResearch: "Collaboration de recherche",
    inquiryRehab: "Rééducation / recherche clinique",
    inquiryCare: "Résidence seniors / soin",
    inquiryInvestor: "Demande investisseurs",
    inquiryMedia: "Médias",
    subjectLabel: "Objet (facultatif)",
    messageLabel: "Message",
    medicalNote:
      "Veuillez ne pas envoyer d’informations médicales confidentielles via ce formulaire.",
    ...
    error: "Veuillez renseigner le nom, l’e-mail, le type de demande et le message.",
    fallbackNote:
