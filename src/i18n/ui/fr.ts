...
export const uiFr: UiMessages = {
  ...
  contact: {
    ...
    submit: "Ouvrir dans l’application e-mail",
    success: "Votre application e-mail devrait s’ouvrir avec le message prêt à envoyer.",
