...
export const uiFr: UiMessages = {
  ...
  lab: {
    ...
    particleHeroTitle: "Les robots aident les personnes",
    particleHeroLead:
      "Une expérience-histoire en particules : SAVEN aide à permettre la compréhension, puis l’assistance physique, puis un moment de soin. Canvas = images seulement. L’accueil public reste le collage photo.",
    beatsLabel: "Temps de l’histoire",
    beatUnderstanding: "Compréhension",
    beatUnderstandingNote: "Contexte humain et énergie — le côté système qui soutient le soin.",
    beatAssistance: "Assistance",
    beatAssistanceNote: "Un bras robotique tend de l’eau — aide physique sous contrôle humain.",
    beatCare: "Soin",
    beatCareNote: "Un moment d’assistance humanoïde — les robots aident les personnes là où la vie se passe.",
  ...
  home: { developmentStatus: "Architecture", architectureOverview: "L’idée en un regard", architectureOverviewText: "Des personnes et de l’information aux systèmes qui aident dans la vie quotidienne — dans des limites claires.", knowledgeExplorer: "Explorer", majorDomains: "Sujets principaux", publishedPages: "Pages ici", relationships: "Comment cela se relie", domainMap: "Découvrir", architectureDependencies: "Comment les sujets s’articulent", currentStatus: "Avancement", platformProgress: "Sujets", featuredConcepts: "Découvrir", startWithCore: "Quelques idées pour commencer", continueExploring: "Continuer", chooseEntrance: "Choisissez un point de départ", knowledgeId: "ID du document", complete: "Terminé", inProgress: "Actif", planned: "Réservé", understand: "Comprendre", explore: "Explorer", discover: "Découvrir", continue: "Continuer", beatWhat: "Quoi", beatWho: "Qui", beatWhy: "Pourquoi", beatHow: "Comment", hourFramesLabel: "Une heure de soin", watchTitle: "Voir SAVEN Core", watchSupport: "Une courte présentation d’ensemble de SAVEN Core — des systèmes intelligents conçus pour soutenir la vie humaine.", watchEmbedTitle: "Vidéo de présentation SAVEN Core", particleHeroLabel: "Visualisation de particules en morphose", particlePreviewTitle: "Expérience hero particules", particlePreviewLead: "Page de test interne pour le morph WebGL de particules. L’accueil public utilise le collage photo." },
