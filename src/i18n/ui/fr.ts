...
export const uiFr: UiMessages = {
  ...
  footerContact: {
    ...
    lede: "Écrivez à info@savencore.com — partenariats, dialogue de recherche, demande d'investisseur ou questions générales.",
