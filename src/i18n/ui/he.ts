...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "על הרצועה הזו (משולבת ברקע העמוד — קצוות רכים, בלי קופסת וידאו חדה או מסגרת תמונה): וידאו קל בשני פורמטים (WebM + MP4, בחירה למובייל) עם חיתוך שמדלג על הסצנה הראשונה עם פסי שחור (~7.2 שנ׳ ב-1.05×, זום-קרופ מרכזי ~1.14×, מטמון ?v=d0272) וצליל אופציונלי (מתחיל מושתק), בקרת Mute, טקסט עדין מעל הווידאו, קישורי glass-light לדפים מפורסמים, סימני פרקים על פס התקדמות רך, כיתוב שנמוג בגלילה, פרלקס חזק (±~64px + סקייל), אור סמן מרוכך, Ken Burns ~1.06→1.14 ואמביינט צדדי קל לרקע ה-Lab — בלי גרעין, וינייט כבד או דירוג עכור. פינות ישרות; בלי ניאון. בתנועה מופחתת — פחות תנועה ופוסטר.",
    videoEffectsIdeas:
      "רעיונות לעתיד (לא משוחררים): פלייליסט מרובה קליפים, פרלקס מקושר ל-scrub, כותרות פרקים, HDR/AV1 כשהתמיכה תהיה רחבה.",
