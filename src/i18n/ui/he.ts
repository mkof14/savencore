...
export const uiHe: UiMessages = {
  ...
  navEntries: {
    ...
    "footer-company-home": "בית", "footer-company-about": "אודות",
  ...
  lab: { ...uiEn.lab,
    ...
    videoOverlayEyebrow: "ניסוי Lab",
    videoOverlayLine: "חיתוך עבודה — מערכות לטיפול אנושי.",
    videoCaption: "חיתוך עבודה — מערכות שעוצבו לטיפול אנושי בעולם הפיזי.",
    videoCaptionUnderstanding: "הבנה — הסיפור מתחיל באנשים.",
    videoCaptionAssistance: "סיוע — תמיכה לסביבות אמיתיות.",
    videoCaptionCare: "טיפול — מטרת תצוגת ה-Lab הזו.",
    videoCaptionSiteUnderstanding: "הבנה — אנשים והשם נכנסים למסגרת.",
    videoCaptionSiteAssistance: "סיוע — תמיכה המעוצבת לסביבות יומיומיות.",
    videoCaptionSiteCare: "טיפול — מערכות שמכוונות לטיפול אנושי לאורך החיים.",
    videoCaptionSavenUnderstanding: "הבנה — השם מקבל צורה.",
    videoCaptionSavenAssistance: "סיוע — צורות תמיכה בסביבת Lab.",
    videoCaptionSavenCare: "טיפול — מבט קרוב יותר על מערכות שעוצבו לאנשים.",
    videoChaptersLabel: "פרקי הווידאו",
    videoChapterUnderstanding: "פרק: הבנה",
    videoChapterAssistance: "פרק: סיוע",
    videoChapterCare: "פרק: טיפול",
    videoSwitcherLabel: "סרטוני Lab",
    videoClipSite: "Site",
    videoClipGwr: "GWR",
    videoClipSaven: "SAVEN",
    videoMute: "השתק",
    videoUnmute: "בטל השתקה",
    videoLinksLabel: "דפים מפורסמים מניסוי Lab זה",
    videoLinkHome: "דף הבית",
    videoLinkBiomath: "BioMath Core",
    videoLinkInterface: "ממשק רובוטיקה",
    videoLinkContact: "צור קשר",
    videoEffectsHeading: "טיפול בוידאו הפתיחה",
    videoEffectsApplied:
      "על הרצועה הזו (משולבת ברקע העמוד — קצוות רכים, בלי קופסת וידאו חדה או מסגרת תמונה): מחליף קומפקטי לפלייליסט מרובה קליפים (Site + GWR + SAVEN; מוכן לעוד), כל קליפ קל בשני פורמטים (WebM + MP4, בחירה למובייל). Site הוא הקליפ הראשי כברירת מחדל מהמאסטר SAVEN_site 1 (~60 שנ׳, בלי חיתוך שחור); GWR שומר על סצנת דמות הנקודות ממאסטר t=0 (~10 שנ׳); SAVEN הוא חיתוך המותג S-2 (~10 שנ׳ אחרי הסרת ראש שחור טהור בלבד). פריים 16:9 מקורי, מטמון ?v=d0278; צליל אופציונלי (מתחיל מושתק), Mute, טקסט עדין, קישורי glass-light, פרקים וכתוביות הבנה → סיוע → טיפול לפי הקליפ הפעיל, כיתוב בגלילה, פרלקס קל, אור סמן, Ken Burns ואמביינט צדדי — בלי גרעין, וינייט כבד או דירוג עכור. פינות ישרות; בלי ניאון. בתנועה מופחתת — פחות תנועה ופוסטר.",
    videoEffectsIdeas:
      "רעיונות לעתיד (לא משוחררים): עוד קליפי Lab באותו מחליף, פרלקס עומק מקושר ל-scrub, HDR/AV1 כשהתמיכה תהיה רחבה.",
