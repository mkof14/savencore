...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    videoFrameEyebrow: "ניסוי Lab",
    videoCaption: "חיתוך עבודה — מערכות שעוצבו לטיפול אנושי בעולם הפיזי.",
    videoWatchChip: "צפייה · Lab",
    videoMute: "השתק",
    videoUnmute: "בטל השתקה",
    videoEffectsHeading: "טיפול בוידאו הפתיחה",
    videoEffectsApplied:
      "על הרצועה הזו: וידאו קל אחד בשני פורמטים (WebM + MP4, בחירה למובייל) עם חיתוך עריכתי מדויק יותר וצליל אופציונלי (מתחיל מושתק), מסגרת עריכתית עם סימני פינות, כיתוב מאופק, שבב צפייה · Lab, התקדמות לולאה דקה, פרלקס גלילה עדין, אור סמן בשולחן העבודה, סקייל Ken Burns, וינייט רך, דהייה תחתונה, גרעין עדין, דירוג צבע קל ודהייה חלקה. פינות ישרות; בלי ניאון. בתנועה מופחתת — פחות תנועה ופוסטר.",
    videoEffectsIdeas:
