...
export const uiHe: UiMessages = {
  ...
  legal: {
    ...
    indexTitle: "משפטי",
    indexLead:
      "דפי טיוטה מבניים לאתר הציבורי. אינם טקסט משפטי סופי — ממתינים לסקירה משפטית.",
  },
  ...
  footerContact: {
    heading: "צרו קשר",
    lede: "כתבו אל info@savencore.com — שותפויות, דיאלוג מחקר, פניות משקיעים או שאלות כלליות.",
    submit: "שלח הודעה",
    submitMailto: "פתח באפליקציית הדוא\"ל",
  },
