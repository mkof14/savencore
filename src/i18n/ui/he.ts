...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "על הרצועה הזו: וידאו קל בשני פורמטים (WebM + MP4, בחירה למובייל), סקייל Ken Burns, וינייט רך, דהייה תחתונה לעמוד, גרעין פילם עדין, דירוג צבע קל, שכבת עומק מטושטשת אופציונלית (שולחן עבודה) ודהייה חלקה כשמוכן. פינות ישרות; בלי ניאון. בתנועה מופחתת — פוסטר בלבד.",
    videoEffectsIdeas:
      "רעיונות לעתיד (לא משוחררים): פרלקס בגלילה, אור סמן אינטראקטיבי, חיתוכי פרקים / פלייליסט מרובה קליפים, אודיו עדין עם השתקה, HDR/AV1 כשהתמיכה תהיה רחבה.",
