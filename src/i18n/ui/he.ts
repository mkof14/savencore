...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "על הרצועה הזו (מלא רוחב, בלי מסגרת תמונה): וידאו קל בשני פורמטים (WebM + MP4, בחירה למובייל) עם חיתוך מחדש (~7.2 שנ׳ במהירות קלה 1.05×) וצליל אופציונלי (מתחיל מושתק), בקרת Mute, כיתוב דק מתחת לווידאו, התקדמות לולאה, פרלקס גלילה חזק (±~64px + סקייל), זרקור סמן ברור בשולחן העבודה, זום Ken Burns עד ~1.12, וינייט ברור, גרעין, דירוג צבע ודהייה. פינות ישרות; בלי ניאון. בתנועה מופחתת — פחות תנועה ופוסטר.",
    videoEffectsIdeas:
