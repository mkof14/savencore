...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "על הרצועה הזו: וידאו קל אחד בשני פורמטים (WebM + MP4, בחירה למובייל), סקייל Ken Burns, וינייט רך, דהייה תחתונה לעמוד, גרעין פילם עדין, דירוג צבע קל ודהייה חלקה כשמוכן. פינות ישרות; בלי ניאון. בתנועה מופחתת — פוסטר בלבד.",
    videoEffectsIdeas:
