...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    particleHeroTitle: "רובוטים עוזרים לאנשים",
    particleHeroLead:
      "ניסוי סיפור חלקיקים: SAVEN מסייע לאפשר הבנה, אחר כך סיוע פיזי, ואז רגע של טיפול. הקנבס תמונות בלבד. דף הבית נשאר קולאז׳ תמונות.",
    beatsLabel: "מקצבי הסיפור",
    beatUnderstanding: "הבנה",
    beatUnderstandingNote: "הקשר אנושי ואנרגיה — צד המערכת שתומך בטיפול.",
    beatAssistance: "סיוע",
    beatAssistanceNote: "זרוע רובוטית מגישה מים — עזרה פיזית תחת שליטה אנושית.",
    beatCare: "טיפול",
    beatCareNote: "רגע סיוע דמוי-אדם — רובוטים עוזרים לאנשים במקום שבו החיים קורים.",
  ...
  home: {
    ...
    particlePreviewTitle: "ניסוי הירו של חלקיקים",
    particlePreviewLead: "דף בדיקה פנימי למורף החלקיקים. דף הבית הציבורי משתמש בקולאז׳ התמונות.",
  },
