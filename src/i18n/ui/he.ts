...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "על הרצועה הזו (משולבת ברקע העמוד — קצוות רכים, בלי קופסת וידאו חדה או מסגרת תמונה): וידאו קל בשני פורמטים (WebM + MP4, בחירה למובייל) עם חיתוך שמדלג על הסצנה הראשונה עם פסי שחור (~7.6 שנ׳ בלולאה, פריים 16:9 מקורי, מטמון ?v=d0275) וצליל אופציונלי (מתחיל מושתק), בקרת Mute, טקסט עדין מעל הווידאו, קישורי glass-light לדפים מפורסמים, סימני פרקים לחיצים שקופצים לזמני סצנה, כתוביות מתוזמנות הבנה → סיוע → טיפול, כיתוב שנמוג בגלילה, פרלקס קל, אור סמן מרוכך, Ken Burns עדין ואמביינט צדדי קל לרקע ה-Lab — בלי גרעין, וינייט כבד או דירוג עכור. פינות ישרות; בלי ניאון. בתנועה מופחתת — פחות תנועה ופוסטר.",
    videoEffectsIdeas:
