...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "על הרצועה הזו (משולבת ברקע העמוד — קצוות רכים, בלי קופסת וידאו חדה או מסגרת תמונה): מחליף קומפקטי לפלייליסט מרובה קליפים (GWR + SAVEN; מוכן לעוד), כל קליפ קל בשני פורמטים (WebM + MP4, בחירה למובייל). GWR שומר על סצנת דמות הנקודות ממאסטר t=0 (~10 שנ׳); SAVEN הוא חיתוך המותג S-2 (~10 שנ׳ אחרי הסרת ראש שחור טהור בלבד). פריים 16:9 מקורי, מטמון ?v=d0277; צליל אופציונלי (מתחיל מושתק), Mute, טקסט עדין, קישורי glass-light, פרקים וכתוביות הבנה → סיוע → טיפול לפי הקליפ הפעיל, כיתוב בגלילה, פרלקס קל, אור סמן, Ken Burns ואמביינט צדדי — בלי גרעין, וינייט כבד או דירוג עכור. פינות ישרות; בלי ניאון. בתנועה מופחתת — פחות תנועה ופוסטר.",
    videoEffectsIdeas:
