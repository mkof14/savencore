...
export const uiHe: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "על הרצועה הזו (משולבת ברקע העמוד — קצוות רכים, בלי קופסת וידאו חדה או מסגרת תמונה): וידאו קל בשני פורמטים (WebM + MP4, בחירה למובייל) עם חיתוך שמדלג על הסצנה הראשונה עם פסי שחור (~7.2 שנ׳ ב-1.05×, זום-קרופ מרכזי ~1.14×, מטמון ?v=d0271) וצליל אופציונלי (מתחיל מושתק), בקרת Mute, כיתוב דק, התקדמות לולאה, פרלקס חזק (±~64px + סקייל), זרקור סמן בשולחן העבודה, Ken Burns ~1.06→1.14, וינייט/דהייה רכה לרקע ה-Lab, גרעין ודירוג צבע. פינות ישרות; בלי ניאון. בתנועה מופחתת — פחות תנועה ופוסטר.",
    videoEffectsIdeas:
      "רעיונות לעתיד (לא משוחררים): חיתוכי פרקים / פלייליסט מרובה קליפים, פרלקס מקושר ל-scrub, HDR/AV1 כשהתמיכה תהיה רחבה.",
