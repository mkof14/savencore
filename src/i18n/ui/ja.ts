...
export const uiJa: UiMessages = {
  ...
  nav: { home: "ホーム", technology: "技術", systems: "システム", applications: "応用", trust: "信頼", research: "研究", purpose: "目的", foundation: "基盤", labs: "ラボ", investors: "投資家", partners: "パートナー", signIn: "サインイン / 登録" },
