...
export const uiJa: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "この帯に適用（ページ背景に溶け込む・柔らかいフェザー縁、硬い動画枠や額縁なし）：軽量デュアル形式の動画1本（WebM + MP4、モバイル選択）、レターボックス付きの最初のシーンを飛ばす再カット（約7.2秒・1.05×、中央ズームクロップ約1.14×、キャッシュ ?v=d0271）、任意の音声（開始時はミュート）、Mute 操作、細いキャプション、ループ進行、強いスクロールパララックス（±約64px＋スケール）、デスクトップ・カーソルスポットライト、Ken Burns 約1.06→1.14、Lab背景へ馴染む柔らかいビネット／フェード、グレイン、カラーグレード。直角コーナー、ネオンなし。動きを抑える設定ではモーションを弱め、ポスターを表示。",
    videoEffectsIdeas:
      "将来のアイデア（未実装）：チャプターカット／複数クリップ、スクラブ連動パララックス、広い対応時の HDR/AV1。",
