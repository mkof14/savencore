...
export const uiJa: UiMessages = {
  ...
  lab: {
    ...
    videoFrameEyebrow: "Lab 実験",
    videoCaption:
      "作業用のカット — 物理世界での人のケアのために形づくられるシステム。",
    videoWatchChip: "視聴 · Lab",
    videoMute: "ミュート",
    videoUnmute: "ミュート解除",
    videoEffectsHeading: "動画スプラッシュの演出",
    videoEffectsApplied:
      "この帯に適用：軽量デュアル形式の動画1本（WebM + MP4、モバイル選択）とより意図的な編集カット、任意の音声（開始時はミュート）、コーナーマーク付きの編集フレーム、控えめなキャプション、視聴 · Lab チップ、細いループ進行、さりげないスクロールパララックス、デスクトップのカーソルライト、Ken Burns スケール、ソフトビネット、下部フェード、細かいフィルムグレイン、軽いカラーグレード、準備完了時のスムーズなフェードイン。直角コーナー、ネオンなし。動きを抑える設定ではモーションを弱め、ポスターを表示。",
    videoEffectsIdeas:
