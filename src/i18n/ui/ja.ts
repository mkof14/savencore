...
export const uiJa: UiMessages = {
  ...
  lab: {
    ...
    featuredBadge: "注目の実験",
    particleHeroTitle: "ロボットは人を助ける",
    particleHeroLead:
      "パーティクルによるストーリー実験：SAVEN は理解を支え、次に身体的な支援、そしてケアの瞬間へ。キャンバスは画像のみ。公開ホームはフォトコラージュのままです。",
    beatsLabel: "ストーリーの拍",
    beatUnderstanding: "理解",
    beatUnderstandingNote: "人の文脈とエネルギー — ケアを支えるシステムの側。",
    beatAssistance: "支援",
    beatAssistanceNote: "ロボットアームが水を渡す — 人の制御下での物理的な助け。",
    beatCare: "ケア",
    beatCareNote: "ヒューマノイドの支援の瞬間 — ロボットは暮らしの場で人を助ける。",
  ...
  home: { developmentStatus: "アーキテクチャ", architectureOverview: "ひと目でわかる考え方", architectureOverviewText: "人と情報から、日常の生活を支えるシステムへ。明確な範囲のもとで進めます。", knowledgeExplorer: "見る", majorDomains: "主なテーマ", publishedPages: "このページ群", relationships: "つながり", domainMap: "見つける", architectureDependencies: "テーマのつながり", currentStatus: "進捗", platformProgress: "テーマ", featuredConcepts: "見つける", startWithCore: "はじめに読む考え方", continueExploring: "続ける", chooseEntrance: "始める場所を選ぶ", knowledgeId: "文書ID", complete: "完了", inProgress: "進行中", planned: "対象範囲", understand: "理解する", explore: "見る", discover: "見つける", continue: "続ける", beatWhat: "何を", beatWho: "誰に", beatWhy: "なぜ", beatHow: "どう", hourFramesLabel: "ケアの一時間", watchTitle: "SAVEN Core を見る", watchSupport: "SAVEN Core の短い概要プレゼンテーション — 人の暮らしを支えるために作られる知能システムです。", watchEmbedTitle: "SAVEN Core 紹介動画", particleHeroLabel: "パーティクル変形のビジュアル", particlePreviewTitle: "パーティクルヒーロー実験", particlePreviewLead: "WebGLパーティクル変形の内部テストページです。公開ホームは写真コラージュを使用します。" },
