...
export const uiJa: UiMessages = {
  ...
  contact: {
    ...
    messageLabel: "メッセージ",
    submit: "メールアプリで開く",
    success: "送信準備済みのメッセージでメールアプリが開きます。",
