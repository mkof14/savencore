...
export const uiJa: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "この帯に適用：軽量デュアル形式動画（WebM + MP4、モバイル選択）、Ken Burns スケール、ソフトビネット、ページへの下部フェード、細かいフィルムグレイン、軽いカラーグレード、任意のぼかし深度レイヤー（デスクトップ）、準備完了時のスムーズなフェードイン。直角コーナー、ネオンなし。動きを抑える設定ではポスターのみ。",
    videoEffectsIdeas:
      "将来のアイデア（未実装）：スクロールパララックス、カーソルライト、チャプターカット／複数クリップ、ミュート付き控えめ音声、広い対応時の HDR/AV1。",
