...
export const uiJa: UiMessages = {
  ...
  home: { developmentStatus: "アーキテクチャ", architectureOverview: "ひと目でわかる考え方", architectureOverviewText: "人と情報から、日常の生活を支えるシステムへ。明確な範囲のもとで進めます。", knowledgeExplorer: "見る", majorDomains: "主なテーマ", publishedPages: "このページ群", relationships: "つながり", domainMap: "見つける", architectureDependencies: "テーマのつながり", currentStatus: "進捗", platformProgress: "テーマ", featuredConcepts: "見つける", startWithCore: "はじめに読む考え方", continueExploring: "続ける", chooseEntrance: "始める場所を選ぶ", knowledgeId: "文書ID", complete: "完了", inProgress: "進行中", planned: "対象範囲", understand: "理解する", explore: "見る", discover: "見つける", continue: "続ける", beatWhat: "何を", beatWho: "誰に", beatWhy: "なぜ", beatHow: "どう", hourFramesLabel: "ケアの一時間", watchTitle: "SAVEN Core を見る", watchSupport: "SAVEN Core の短い概要プレゼンテーション — 人の暮らしを支えるために作られる知能システムです。", watchEmbedTitle: "SAVEN Core 紹介動画", particleHeroLabel: "パーティクル変形のビジュアル" },
