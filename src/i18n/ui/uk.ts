...
export const uiUk: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "На цій смузі (вписано у фон сторінки — м’які краї, без жорсткої відеорамки чи картинної рамки): одне легке відео у двох форматах (WebM + MP4, вибір для мобільних), що зберігає початкову сцену людини з точок з master t=0 (~10 с цикл, оригінальний 16:9, кеш ?v=d0276; на відкритті може лишатися легкий letterbox джерела) і опційним звуком (старт без звуку), кнопка Mute, стриманий текст поверх відео, glass-light посилання на опубліковані сторінки, клікабельні мітки глав із переходом до часу сцени, підписи за часом Розуміння → Допомога → Турбота, підпис, що згасає при прокручуванні, легкий паралакс, пом’якшене світло курсора, м’який Ken Burns і легке бічне ambient у фон Lab — без зерна, важкої віньєтки чи каламутної кольорокорекції. Прямі кути; без неону. Зі зменшеним рухом — менше motion і постер.",
    videoEffectsIdeas:
      "Ідеї на майбутнє (не впроваджено): мультикліп-плейлист, паралакс глибини, пов’язаний зі scrub, HDR/AV1 за широкої підтримки.",
