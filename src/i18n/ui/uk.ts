...
export const uiUk: UiMessages = {
  ...
  lab: {
    ...
    particleHeroTitle: "Людина + енергетичні хвилі",
    particleHeroLead:
      "WebGL-морфінг часток — точкова фігура людини з потоками енергії SAVEN. На полотні лише зображення. Публічна головна лишається фотоколажем.",
