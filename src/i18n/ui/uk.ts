...
export const uiUk: UiMessages = {
  ...
  legal: {
    ...
    draftNote: "Політики сайту щодо інформаційних практик і умов використання. Питання: info@savencore.com.",
    indexTitle: "Правова інформація",
    indexLead: "Конфіденційність, умови, cookies, доступність, безпека та пов’язані повідомлення публічного сайту. У вподобаннях cookies зазначено, що живого CMP згоди немає — використовуйте налаштування браузера або зв’яжіться з нами.",
  },
