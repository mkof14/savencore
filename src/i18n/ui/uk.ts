...
export const uiUk: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "На цій смузі (вписано у фон сторінки — м’які краї, без жорсткої відеорамки чи картинної рамки): одне легке відео у двох форматах (WebM + MP4, вибір для мобільних) з монтажем, що пропускає першу сцену з чорними смугами (~7,2 с на 1,05×, центральний zoom-crop ~1,14×, кеш ?v=d0272) і опційним звуком (старт без звуку), кнопка Mute, стриманий текст поверх відео, glass-light посилання на опубліковані сторінки, мітки глав на м’якій смузі прогресу, підпис, що згасає при прокручуванні, сильний паралакс (±~64px + масштаб), пом’якшене світло курсора, Ken Burns ~1,06→1,14 і легке бічне ambient у фон Lab — без зерна, важкої віньєтки чи каламутної кольорокорекції. Прямі кути; без неону. Зі зменшеним рухом — менше motion і постер.",
    videoEffectsIdeas:
      "Ідеї на майбутнє (не впроваджено): мультикліп-плейлист, паралакс, пов’язаний зі scrub, заголовки глав, HDR/AV1 за широкої підтримки.",
