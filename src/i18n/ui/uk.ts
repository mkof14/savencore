...
export const uiUk: UiMessages = {
  ...
  lab: {
    ...
    featuredBadge: "Обраний експеримент",
    particleHeroTitle: "Роботи допомагають людям",
    particleHeroLead:
      "Експеримент-історія на частках: SAVEN допомагає забезпечувати розуміння, потім фізичну допомогу, потім момент турботи. На полотні лише зображення. Публічна головна лишається фотоколажем.",
    beatsLabel: "Біти історії",
    beatUnderstanding: "Розуміння",
    beatUnderstandingNote: "Людський контекст і енергія — системний бік підтримки турботи.",
    beatAssistance: "Допомога",
    beatAssistanceNote: "Роботизована рука подає воду — фізична допомога під контролем людини.",
    beatCare: "Турбота",
    beatCareNote: "Момент гуманоїдної допомоги — роботи допомагають людям там, де відбувається життя.",
    openExperiment: "Відкрити експеримент",
    backToLab: "← Назад до Lab",
