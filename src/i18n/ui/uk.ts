...
export const uiUk: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "На цій смузі (вписано у фон сторінки — м’які краї, без жорсткої відеорамки чи картинної рамки): одне легке відео у двох форматах (WebM + MP4, вибір для мобільних) з монтажем, що пропускає першу сцену з чорними смугами (~7,2 с на 1,05×, центральний zoom-crop ~1,14×, кеш ?v=d0271) і опційним звуком (старт без звуку), кнопка Mute, тонкий підпис, прогрес циклу, сильний паралакс (±~64px + масштаб), світло курсора на десктопі, Ken Burns ~1,06→1,14, м’яка тематична віньєтка/згасання у фон Lab, зерно й кольорокорекція. Прямі кути; без неону. Зі зменшеним рухом — менше motion і постер.",
    videoEffectsIdeas:
