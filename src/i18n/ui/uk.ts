...
export const uiUk: UiMessages = {
  ...
  lab: {
    ...
    videoFrameEyebrow: "Експеримент Lab",
    videoCaption:
      "Робочий монтаж — системи, сформовані для людської турботи у фізичному світі.",
    videoWatchChip: "Дивитись · Lab",
    videoMute: "Вимкнути звук",
    videoUnmute: "Увімкнути звук",
    videoEffectsHeading: "Обробка відео-сплешу",
    videoEffectsApplied:
      "На цій смузі: одне легке відео у двох форматах (WebM + MP4, вибір для мобільних) з чіткішим редакційним монтажем і опційним звуком (старт без звуку), редакційна рамка з кутовими мітками, стриманий підпис, чіп Дивитись · Lab, тонка смуга прогресу циклу, легкий паралакс при скролі, світло курсора на десктопі, масштаб Ken Burns, м’яка віньєтка, нижній градієнт, дрібне зерно, легка кольорокорекція і плавне поява. Прямі кути; без неону. Зі зменшеним рухом — менше motion і постер.",
    videoEffectsIdeas:
