...
export const uiUk: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "На цій смузі: легке відео у двох форматах (WebM + MP4, вибір для мобільних), масштаб Ken Burns, м’яка віньєтка, нижній градієнт у сторінку, дрібне зерно плівки, легка кольорокорекція, опційний розмитий шар глибини (десктоп) і плавне поява. Прямі кути; без неону. Зі зменшеним рухом — лише постер.",
    videoEffectsIdeas:
      "Ідеї на майбутнє (не впроваджено): паралакс при скролі, інтерактивне світло курсора, нарізки глав / мультикліп-плейлист, тихий звук з mute, HDR/AV1 за широкої підтримки.",
