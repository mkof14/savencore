...
export const uiUk: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "На цій смузі: одне легке відео у двох форматах (WebM + MP4, вибір для мобільних), масштаб Ken Burns, м’яка віньєтка, нижній градієнт у сторінку, дрібне зерно плівки, легка кольорокорекція і плавне поява. Прямі кути; без неону. Зі зменшеним рухом — лише постер.",
    videoEffectsIdeas:
