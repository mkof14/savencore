...
export const uiZhCn: UiMessages = {
  ...
  lab: {
    ...
    videoEffectsApplied:
      "本区带已应用（全幅铺满、无画框）：一条轻量双格式视频（WebM + MP4，移动端优选）、重新剪辑（约 7.2 秒、轻微 1.05× 速度）、可选声音（默认静音）、Mute 控件、视频下方细字幕、循环进度、明显滚动视差（约 ±64px + 缩放）、桌面光标聚光灯、Ken Burns 缩放至约 1.12、清晰暗角、胶片颗粒、调色与淡入。直角边；无霓虹。减少动态时减弱动效并显示海报。",
    videoEffectsIdeas:
