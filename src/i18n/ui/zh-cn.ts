...
export const uiZhCn: UiMessages = {
  ...
  admin: { ...uiEn.admin, brandTitle: "SAVEN Admin", navLabel: "管理导航", statusInDevelopment: "开发中", eyebrow: "管理平台", backToSite: "返回网站", signOut: "退出登录", navDashboard: "控制台", navEmailTemplates: "邮件模板", navMailings: "邮件发送", navInvitations: "邀请", navUsers: "用户与角色", navPermissions: "权限", navNotifications: "通知", navMedia: "媒体库", navMarketing: "营销工具", navMonitoring: "技术监控", openSection: "打开", dashboardTitle: "网站管理", emailTitle: "邮件模板", mediaTitle: "媒体库", mediaLinkHeading: "添加链接", mediaLinkAdd: "添加链接", mediaFilterAll: "全部", actionDelete: "删除", marketingTitle: "营销工具", monitoringTitle: "技术监控", actionPreview: "预览", actionCopy: "复制", actionPrint: "打印", actionShare: "分享", actionDownload: "下载", actionPdf: "PDF" },
  auth: {
