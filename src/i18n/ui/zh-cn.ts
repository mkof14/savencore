...
export const uiZhCn: UiMessages = {
  ...
  nav: { home: "首页", technology: "技术", systems: "系统", applications: "应用", trust: "信任", research: "研究", purpose: "宗旨", foundation: "基础", labs: "实验室", investors: "投资者", partners: "合作伙伴", signIn: "登录 / 注册" },
