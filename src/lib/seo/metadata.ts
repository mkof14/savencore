...
export function buildLocaleLayoutMetadata(locale: Locale): Metadata {
  ...
  return {
    ...
    /** Prefer largest practical brand icons (D-0204/D-0205); ?v=208 busts sticky browser caches. */
    icons: {
      icon: [
        { url: "/favicon.svg?v=208", type: "image/svg+xml" },
        { url: "/favicon.ico?v=208", sizes: "16x16 32x32 48x48 64x64" },
        {
          url: "/favicon-32x32.png?v=208",
          sizes: "32x32",
          type: "image/png",
        },
        {
          url: "/favicon-48x48.png?v=208",
          sizes: "48x48",
          type: "image/png",
        },
        {
          url: "/icons/icon-192.png?v=208",
          sizes: "192x192",
          type: "image/png",
        },
        {
          url: "/icons/icon-512.png?v=208",
          sizes: "512x512",
          type: "image/png",
        },
      ],
      apple: [
        {
          url: "/icons/apple-touch-icon.png?v=208",
          sizes: "180x180",
          type: "image/png",
        },
      ],
      shortcut: "/favicon-48x48.png?v=208",
    },
    appleWebApp: {
      capable: true,
      title: SITE_NAME,
